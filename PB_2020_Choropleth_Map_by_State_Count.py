...
title_of_layout = "2020 Police Brutality: {} Incidents Captured on Video<br>Data from {} to {}<br>Date Created: {} MST".format(len(pb_data_raw),first_date,last_date,dt_string)
...
# Save html
choromap_pb2020.write_html(r"C:\Users\cdwhi\Documents\Python\My_Code\Police_Brutality_2020\PB_2020_Choropleth_Map_by_State_Count\index.html")
